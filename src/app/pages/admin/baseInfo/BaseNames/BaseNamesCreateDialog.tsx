...
export function BaseNamesCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<BaseNamesModel>({mode: 'all'})
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    let url = API_URLCoding + 'baseNames'
