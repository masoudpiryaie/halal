...
import {EducationCreateDialog, EducationModel} from './EducationCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.EducationController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && <EducationCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
