...
type PropsType = {
  mode: FormMode
  onClose: () => void
  item?: MembershipCompanyTypeModel
}
export type MembershipCompanyTypeModel = {
  id?: number
  titleFa: string
  titleEn: string
}
...
export function MembershipCompanyTypeCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<MembershipCompanyTypeModel>({mode: 'all'})
  ...
  const onSubmit = handleSubmit(async (data) => {
    let url = API_URL + 'MembershipCompanyType'
