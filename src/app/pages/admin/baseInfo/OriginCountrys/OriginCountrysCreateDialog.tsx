...
type PropsType = {
  mode: FormMode
  onClose: () => void
  item?: OriginCountrysModel
}
export type OriginCountrysModel = {
  id?: number
  titleFa: string
  titleEn: string
}
...
export function OriginCountrysCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<OriginCountrysModel>({mode: 'all'})
  ...
  const onSubmit = handleSubmit(async (data) => {
    let url = API_URL + 'OriginCountrys'
