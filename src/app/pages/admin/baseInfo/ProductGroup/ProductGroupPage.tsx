...
import {ProductGroupCreateDialog, ProductGroupModel} from './ProductGroupCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.ProductGroupController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && (
        <ProductGroupCreateDialog mode={mode} onClose={handleClose} item={actionItem} />
      )}
