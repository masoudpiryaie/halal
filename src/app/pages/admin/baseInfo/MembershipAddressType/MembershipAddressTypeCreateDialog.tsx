...
type PropsType = {
  mode: FormMode
  onClose: () => void
  item?: MembershipAddressTypeModel
}
export type MembershipAddressTypeModel = {
  id?: number
  titleFa: string
  titleEn: string
}
...
export function MembershipAddressTypeCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<MembershipAddressTypeModel>({mode: 'all'})
  ...
  const onSubmit = handleSubmit(async (data) => {
    let url = API_URL + 'MembershipAddressType'
