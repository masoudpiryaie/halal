...
export function GLNListPage() {
  ...
  const gr = localStorage.getItem('GLNListGrid')
  ...
  const searchItems = ['کد*code-0', 'کد پستی*postalCode-0']
  var col = gr
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.GLNListController'})}
      </PageTitle>
