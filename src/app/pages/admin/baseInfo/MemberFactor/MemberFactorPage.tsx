...
export function MemberFactorPage() {
  const intl = useIntl()
  ...
  const gr = localStorage.getItem('MemberFactorGrid')
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.MemberFactorController'})}
      </PageTitle>
