...
import {PackageTypeCreateDialog, PackageTypeModel} from './PackageTypeCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.PackageTypeController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && (
        <PackageTypeCreateDialog mode={mode} onClose={handleClose} item={actionItem} />
      )}
                    ...
                    return (
                      <div className='box'>
                        ...
                        >
                          ...
                          <option value='latinName'>نام لاتین</option>
                        ...
                        {(x.field === 'name' || x.field === 'latinName') && (
                          <input
                            style={{width: '30%', display: 'inline'}}
                            className={
                              x.value === '' ? 'is-invalid form-control' : 'is-valid form-control'
                            }
                            name='value'
                        ...
                        {/* {x.field === 'isActive' && (
                          <select name='isActive' onChange={(e) => handleInputChange(e, i)}>
                            <option value='true'>
            ...
            <div className='card card-px-0 shadow'>
              <div className='card-body'>
                ...
                >
                  ...
                  <GridColumn field='latinName' title='نام لاتین' />
