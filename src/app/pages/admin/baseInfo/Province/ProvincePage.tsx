...
import {ProvinceModel, ProvinceCreateDialog} from './ProvinceCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.ProvinceController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && <ProvinceCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
