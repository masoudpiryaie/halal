...
type PropsType = {
  mode: FormMode
  onClose: () => void
  item?: PureContentUnitsModel
}
export type PureContentUnitsModel = {
  id?: number
  titleFa: string
  titleEn: string
}
...
export function PureContentUnitsCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<PureContentUnitsModel>({mode: 'all'})
  ...
  const onSubmit = handleSubmit(async (data) => {
    let url = API_URL + 'PureContentUnits'
