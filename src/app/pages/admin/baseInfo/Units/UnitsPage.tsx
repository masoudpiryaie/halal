...
import {UnitsCreateDialog, UnitsModel} from './UnitsCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.UnitsController'})}
      </PageTitle>
      <PageActions>
            ...
            <div className='card card-px-0 shadow'>
              <div className='card-body'>
                ...
                >
                  <GridColumn
                    field='titleFa'
                    title={intl.formatMessage({id: 'Model.Units.TitleFa'})}
                  />
                  <GridColumn
                    field='titleEn'
                    title={intl.formatMessage({id: 'Model.Units.TitleEn'})}
                  />
                  <GridColumn
                    field='symbol'
                    title={intl.formatMessage({id: 'Model.Units.Symbol'})}
                  />
                  <GridColumn field='sign' title={intl.formatMessage({id: 'Model.Units.Sign'})} />
                  <GridColumn field='code' title={intl.formatMessage({id: 'Model.Units.Code'})} />
                </Grid>
              </div>
            </div>
          </div>
