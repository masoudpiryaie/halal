...
type PropsType = {
  mode: FormMode
  onClose: () => void
  item?: TargetMarketsModel
}
export type TargetMarketsModel = {
  id?: number
  titleFa: string
  titleEn: string
}
...
export function TargetMarketsCreateDialog({mode, onClose, item}: PropsType) {
  const intl = useIntl()
  ...
  } = useForm<TargetMarketsModel>({mode: 'all'})
