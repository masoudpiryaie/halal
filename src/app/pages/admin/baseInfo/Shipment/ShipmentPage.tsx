...
import {ShipmentCreateDialog, ShipmentModel} from './ShipmentCreateDialog'
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.ShipmentController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && <ShipmentCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
