...
import {LanguagesCreateDialog, LanguagesModel} from './LanguagesCreateDialog'
...
export function LanguagesPage() {
  ...
  const Active = async (id: any) => {
    try {
      debugger
      let url = API_URL + 'Languages/ToggleEnable/' + id
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.LanguagesController'})}
      </PageTitle>

      {showDialog && <LanguagesCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
