...
export function GTINListPage() {
  ...
  const gr = localStorage.getItem('GTINListGrid')
  ...
  const searchItems = ['کد*code-0', 'نام*functionalNameFa-0', 'برند*brandTitleFa-0']
  var col = gr
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.GTINListController'})}
      </PageTitle>
