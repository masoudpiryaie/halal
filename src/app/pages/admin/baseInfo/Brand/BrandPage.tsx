...
import {BrandCreateDialog, BrandModel} from './BrandCreateDialog'
...
export function BrandPage() {
  ...
  async function print() {
    try {
      let response = await axios.post('brand/print/' + 1)
  ...
  return (
    <>
      ...
      {showDialog && <BrandCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
