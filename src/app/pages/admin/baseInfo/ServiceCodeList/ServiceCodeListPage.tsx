...
export function ServiceCodeListPage() {
  const intl = useIntl()
  ...
  const gr = localStorage.getItem('ServiceCodeListGrid')
  ...
  const searchItems = [
    'کد*code-0',
    'نام پایه*payeInfoTitleFa-0',
    'نام پایه انگلیسی*payeInfoTitleEn-0',
  ]
  var col = gr
    ...
    : [
        ...
        {
          title: 'نام پایه ',
          field: 'payeInfoTitleFa',
          show: true,
        },
        {
          title: 'نام پایه انگلیسی ',
          field: 'payeInfoTitleEn',
          show: true,
        },
      ]
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.ServiceCodeListController'})}
      </PageTitle>
            ...
            <div className='card card-px-0 shadow'>
              <div className='card-body'>
                <Grid
                  ...
                  filter={filter}
                  columns={col}
                  name='ServiceCodeListGrid'
                  //exteraParam='&StatusId=11'
                ></Grid>
              </div>
            </div>
          </div>
