...
import {WorthsCreateDialog, WorthsModel} from './WorthsCreateDialog'
import {SearchFunc} from 'app/pages/admin/baseInfo/SearchFunc'
import axios from 'axios'
import {StringSchema} from 'yup'

export function WorthsPage() {
  const intl = useIntl()
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>
        {intl.formatMessage({id: 'MENU.BaseInfo.WorthsController'})}
      </PageTitle>
      <PageActions>
      ...
      {showDialog && <WorthsCreateDialog mode={mode} onClose={handleClose} item={actionItem} />}
